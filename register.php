 ...
 <div class="container">
  ...
  <div class="row">
  	<div class="col-md-12 col-lg-12">
  	 <h2 class="text-center text-uppercase fst-italic">Registration</h2>	
  	</div>
  </div>
  	...
  	<div class="col-md-8 col-lg-8 p-5">
  	 ...
  	 <form class="row needs-validation" novalidate="" method="POST">
  	  ...
  	  <div class="col-md-12 text-end">
  	  	<a href="index" type="button" class="btn btn-outline-primary btn-sm">Back</a> <input type="submit" name="btnTechReg" class="btn btn-outline-dark btn-sm" value="Register">
  	  </div>
