...
<div class="text-center">
	<small class="text-center fw-bolder">No Account click <a href="register" class="animated fadeIn infinite text-primary">here</a> to Register | <a href="forgot">forgot password?</a></small> 
</div>
</div>
