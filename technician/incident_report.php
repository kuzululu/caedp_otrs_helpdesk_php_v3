...
<section>
  ...
  <div class="row">
   ...
   <div class="col-6 mb-3 text-end">
      <button type="submit" name="btnUpdateIncidentReport" class="mt-3 btn btn-outline-success btn-sm"><i class="fa-solid fa-underline"></i></button> <button type="button" class="btn btn-outline-primary btn-sm mt-3 btn-incidentPrintReport"><i class="fa-solid fa-print"></i></button> <a href="incident_records" class="btn btn-outline-danger btn-sm mt-3 text-decoration-none"><i class="fa-solid fa-door-open"></i></a>
   </div>
...
<div class="table-responsive" id="printIncidentReport">
