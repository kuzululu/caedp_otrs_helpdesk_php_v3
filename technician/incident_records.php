...
<section class="printAll">
 <div class="container-fluid">
   <div class="row">
     <div class="text-end">
        <a class="btn btn-outline-success btn-sm btn-printIncidentAll" type="button"><i class="fa fa-print"></i></a>
     </div>
   </div>
 </div> 
</section>
...
<section class="print">
 <div class="container-fluid">
   <div class="row">
     <div class="text-end">
        <a class="btn btn-outline-success btn-sm btn-incidentprint" type="button"><i class="fa fa-print"></i></a>
     </div>
   </div>
 </div> 
</section>
...
?>  	 
  <tr class="text-center align-middle">
    ...
    <td class="align-top"><a target="_blank" href="../upload/<?= htmlspecialchars($row['upload_file']) ?>" class="text-success fst-italic fw-bolder"><?= htmlspecialchars(shortenLinkName($row["upload_file"])) ?></a></td>
  	<td>
  		<a href="incident_report?id=<?= htmlspecialchars(urlencode(base64_encode($row['id']))) ?>&&technician=<?= urlencode(base64_encode($_SESSION['first_name'] . ' ' . $_SESSION['last_name'])) ?>" class="btn btn-outline-secondary btn-sm"><i class="fa-regular fa-eye"></i></a> 
...
<div class="table-responsive" id="incidentAllRecords">
