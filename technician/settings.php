...
?>
    <tr class="text-center align-middle">
      ...
      <td><a class="btn btn-outline-primary btn-sm" href="account_settings?user_id=<?= htmlspecialchars(urlencode(base64_encode($row['user_id']))) ?>"><i class="fa-regular fa-eye"></i></a></td> 
    </tr>
<?php
$ctr++;
   }
