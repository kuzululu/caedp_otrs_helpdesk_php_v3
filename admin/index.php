...
<section class="printAll">
 <div class="container-fluid">
   <div class="row">
     <div class="text-end">
        <a class="btn btn-outline-success btn-sm btn-printAllRecords" type="button"><i class="fa fa-print"></i></a>
     </div>
   </div>
 </div> 
</section>
...
<section class="print">
 <div class="container-fluid">
   <div class="row">
     <div class="text-end">
        <a class="btn btn-outline-success btn-sm btn-printRecords" type="button"><i class="fa fa-print"></i></a>
     </div>
   </div>
 </div> 
</section>
...
?>  	 
  <tr class="text-center align-middle">
    ...
    <td class="alignt-top"><a href="../upload/<?= htmlspecialchars($row["upload_file"]) ?>" class="text-success text-underline fst-italic" target="=_blank"><?= htmlspecialchars(shortenLinkName($row["upload_file"])) ?></a></td>
  	<td>
  		<a href="details?id=<?= htmlspecialchars(urlencode(base64_encode($row['id']))) ?>" class="btn btn-outline-secondary btn-sm"><i class="fa-regular fa-eye"></i></a>
  	</td>
  </tr>
<?php
$ctr++;
...
<div class="table-responsive" id="AllAdminRecords">
...
$allRecordsManager = new AllRecordsAdminManager($conn);
